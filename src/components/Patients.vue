        ...
        <v-form>
            <v-card class="pa-4">
                ...
                <v-row>
                    <v-col>
                        <v-card-actions>
                            <v-btn color="secondary" variant="outlined"><v-icon icon="mdi-close"></v-icon>Close</v-btn>
                            <v-spacer></v-spacer>
                            <v-btn color="secondary" variant="outlined" @click="handleAddPatient">
                                <v-icon icon="mdi-content-save-outline"></v-icon>Save</v-btn>
                        </v-card-actions>
                    </v-col>
                </v-row>
            </v-card>
